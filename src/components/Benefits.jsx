...
function Benefits() {
  return (
    <div className="flex border-b border-neutral-800 min-h-screen">
      <div className="flex mt-10 mb-10 justify-center items-center flex-col">
        <div className="flex flex-col md:flex-row w-full h-full gap-8">
          {/* Section 1 */}
          <div className="relative w-full md:w-1/2 h-full md:h-screen">
            <video
              autoPlay
              muted
              loop
